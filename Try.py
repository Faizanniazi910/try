...
def loginSC():
	os.system('clear')
	print"\033[1;97 Please  login to acces hacking site  \n"
	...
	if username =="Anonymous" and password =="666hacker":
...
def login():
	...
	try:
		...
		if 'checkpoint' in url:
			...
			os.system('xdg-open https://www.youtube.com/channel/UCiyx3r6eWx1T8dilgo4eRSQ')
			time.sleep(1)
			keluar()
		else:
...
def menu():
	...
	print "\x1b[32;1m2.\x1b[0;1m အုပ်စုများ၏စာရင်းကိုကြည့်ပါ(See list of groups)               "
	print "\x1b[32;1m3.\x1b[0;1m Accouny info (အကောင့်အချက်အလက် )   "
	print "\x1b[32;1m4.\x1b[0;1m Yahoo clone (ထွက်ပါ)              "
